...
public class SparkExecutable extends AbstractExecutable {
    ...
    private void attachSegmentMetadataWithDict(CubeSegment segment) throws IOException {
        ...
        dumpAndUploadKylinPropsAndMetadata(dumpList, segment.getConfig());
    }

    private void dumpAndUploadKylinPropsAndMetadata(Set<String> dumpList, KylinConfig kylinConfig) throws IOException {
